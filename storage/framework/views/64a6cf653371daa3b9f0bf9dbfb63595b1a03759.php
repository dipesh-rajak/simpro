...
} elseif ($_instance->childHasBeenRendered('waTPGQu')) {
    $componentId = $_instance->getRenderedChildComponentId('waTPGQu');
    $componentTag = $_instance->getRenderedChildComponentTagName('waTPGQu');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('waTPGQu');
} else {
    $response = \Livewire\Livewire::mount('navigation-dropdown');
    $html = $response->html();
    $_instance->logRenderedChild('waTPGQu', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
</html><?php /**PATH /home/493496.cloudwaysapps.com/zdhrxzffmg/public_html/resources/views/layouts/app.blade.php ENDPATH**/ ?>